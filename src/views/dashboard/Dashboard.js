        ...
        <CCardFooter>
          <CRow className="text-center">
            <CCol md sm="12" className="mb-sm-2 mb-0">
              <div className="text-muted">Lợi nhuận</div>
            ...
            <CCol md sm="12" className="mb-sm-2 mb-0">
              <div className="text-muted">Vốn đầu tư</div>
                  ...
                  <CRow>
                    ...
                    <CCol sm="6">
                      <CCallout color="danger">
                        <small className="text-muted">Chi</small>
                        <br />
                ...
                <CCol xs="12" md="6" xl="6">
                  ...
                  <CRow>
                    <CCol sm="6">
                      <CCallout color="warning">
                        <small className="text-muted">Nguồn tiền</small>
                        <br />
                    ...
                    <CCol sm="6">
                      <CCallout color="success">
                        <small className="text-muted">Tình nguyện</small>
                        <br />
                  ...
                  <div className="progress-group mb-4">
                    <div className="progress-group-header">
                      ...
                      <span className="title">Vốn cố định</span>
                  ...
                  <div className="progress-group mb-5">
                    <div className="progress-group-header">
                      ...
                      <span className="title">Vốn lưu động</span>
                  ...
                  <div className="progress-group">
                    <div className="progress-group-header">
                      ...
                      <span className="title">Thuận</span>
                  ...
                  <div className="progress-group">
                    <div className="progress-group-header">
                      ...
                      <span className="title">CNPM</span>
              ...
              <table className="table table-hover table-outline mb-0 d-none d-sm-table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <div>Nguyễn Minh Tân</div>
                      <div className="small text-muted">
                        <span>CEO</span> | Registered: Jan 1, 2015
                      </div>
                    </td>
                    <td className="text-center">
                      <div>Việt Nam</div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div>Quintin Ed</div>
                      <div className="small text-muted">
                        <span></span> | Registered: Jan 1, 2015
                      </div>
                    </td>
                    <td className="text-center">
